...
def findobj(outputs,img):
    ...
    for i in indices:
        ...
        if x=="cat" or x=="dog" or x=="elephant" or x=="zebra" or x=="giraffe" or x=="bear" :
            playsound('C:\\Users\\komal\\Desktop\\first internship project\\LionRoarSound.mp3')
        elif  x=="sheep" or x=="horse" or x=="sheep" or x=="bird" or x=="cow":
           playsound('C:\\Users\\komal\\Desktop\\first internship project\\CrackersSound.mp3')
